...
echo -e "□ AutoScript By Dev   = XDRG ${GREEN}( RMBL )${NC}"
exp=$( curl -s https://raw.githubusercontent.com/Hunterscrip/izinvps/ip | grep -w $IP | cut -d ' ' -f 3 )
